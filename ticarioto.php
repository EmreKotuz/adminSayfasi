...
if (isset($_POST['12_Ekle']))
{
  ...
  */
  ...
  $komut=$baglanti->prepare("select * from aKategori where arac_id = 2 and aKategori_ad = '1.2'");
  $komut->execute();
...
if (isset($_POST['16_Ekle']))
{
  ...
  $komut=$baglanti->prepare("select * from aKategori where arac_id = 2 and aKategori_ad = '1.6'");
  $komut->execute();
...
if (isset($_POST['20_Ekle']))
{
  ...
  $komut=$baglanti->prepare("select * from aKategori where arac_id = 2 and aKategori_ad = '2.0'");
  $komut->execute();
